...
C
      ...
      character*2 inp, ExaByte, MagTape
      CHARACTER*4 ACCNT                                                         
...
c	so there are no blanks
	...
	IF (FLTNUMB(5:5) .EQ. " ") THEN
          IF (inp.eq.MagTape) then
	    WRITE (38,10201)
     +      AIRCFT,inp,TAPENO(K),YEAR,PROJNO,FLTNO(K),TAPENO(K)
10201       FORMAT (" msimport -n -b50000 -K -Eyes -e99 -j -P41113"A3
     +      " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +      " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A4,"/",A6)
          ELSE
	    WRITE (38,10206)
     +      AIRCFT,inp,TAPENO(K),YEAR,PROJNO,FLTNO(K),TAPENO(K)
10206       FORMAT (" msimport -n -b50000 -K -j -P41113"A3
     +      " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +      " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A4,"/",A6)
          END IF
	ELSE
	    ...
	    WRITE(38,10211)
     +        AIRCFT,inp,TAPENO(K),YEAR,PROJNO,FLTNO(K),TAPENO(K)
10211       FORMAT (" msimport -n -b50000 -K -Eyes -i99 -j -P41113"A3
     +      " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +      " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A5,"/",A6)
          ELSE
	    WRITE(38,10216)
     +        AIRCFT,inp,TAPENO(K),YEAR,PROJNO,FLTNO(K),TAPENO(K)
10216       FORMAT (" msimport -n -b50000 -K -j -P41113"A3
     +      " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +      " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A5,"/",A6)
	  ENDIF
	ENDIF
...
10221     FORMAT (" msimport -n -b50000 -K -j -P41113"A3
     +    " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +    " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A4,"/",A6)
	ELSE
	  WRITE(38,10231)
     +     AIRCFT,inp,TAPENO(1),YEAR,PROJNO,FLTNO(1),TAPENO(1)
10231     FORMAT (" msimport -n -b50000 -K -j -P41113"A3
     +    " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +    " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A5,"/",A6)
	ENDIF
...
C  401 READ(5,'(A5)') FLTNO(NUM+1)                                       
  401 READ(5,'(A)') FLTNO(NUM+1)                                       
