...
10201     FORMAT (" msimport -n -b50000 -Eyes -e99 -j -P41113"A3
     +    " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +    " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A4,"/",A6)
	ELSE
	  WRITE(38,10211)
     +      AIRCFT,inp,TAPENO(K),YEAR,PROJNO,FLTNO(K),TAPENO(K)
10211     FORMAT (" msimport -n -b50000 -Eyes -e99 -j -P41113"A3
     +    " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
...
10221     FORMAT (" msimport -n -b50000 -Eyes -e99 -j -P41113"A3
     +    " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +    " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A4,"/",A6)
	ELSE
	  WRITE(38,10231)
     +     AIRCFT,inp,TAPENO(1),YEAR,PROJNO,FLTNO(1),TAPENO(1)
10231     FORMAT (" msimport -n -b50000 -Eyes -e99 -j -P41113"A3
     +    " -fBI -wRAFDMG -t4095 -uRAF \\"/" -vCTRAFDMG -d1600 -m",A2,
     +    " -MU -N1 ",A6," /RAF/19",I2,"/",A3,"/",A5,"/",A6)
	ENDIF
